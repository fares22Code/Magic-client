...
function Register() {
 ...
 const [desc, setDesc] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (password.length < minLength2 ){
      return toast.error(`Password should be at least ${minLength2} characters long`);
    } else if (!/\d/.test(password) || !/[a-zA-Z]/.test(password)) {
      return toast.error("Password must contain both numbers and characters");
    }
